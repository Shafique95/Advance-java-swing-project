...
public class ForgotPassword extends javax.swing.JFrame {
 ...
 ImageIcon i = new ImageIcon(new ImageIcon("src/images2/i7.png").getImage().getScaledInstance(background.getWidth(),background.getHeight(),Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 190, -1));

        jLabel2.setBackground(new java.awt.Color(0, 0, 0));
        jLabel2.setFont(new java.awt.Font("Harrington", 1, 36)); // NOI18N
        jLabel2.setText("Your Information");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 310, -1));
        ...
        loginButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/user_login2_icon/sendData.png"))); // NOI18N
        ...
        jPanel1.add(loginButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, 190, 60));
        ...
        phoneNumber.setFont(new java.awt.Font("Harrington", 1, 30)); // NOI18N
        jPanel1.add(phoneNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, 210, 40));
    ...
    private void loginButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButton1ActionPerformed
        ...
        if (userName.getText().equals("Admin") && phoneNumber.getText().equals("01734776188")&&userEmail.getText().equals("ad@gmail.com")) {
       
           JOptionPane.showMessageDialog(rootPane, "You have received a password over phone");
